    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Integrate Nookmarks with your browser to easily save bookmarks on the
          go.
        </p>
      </div>
      ...
      <Card className="border border-border bg-card/50 backdrop-blur-sm shadow-xs">
        ...
        <CardContent className="flex flex-col gap-4">
          <div className="flex flex-col items-center justify-center p-6 border-2 border-dashed border-border rounded-lg bg-muted/20 gap-3">
            {bookmarkletUrl ? (
              <a
                ref={linkRef}
                href="#"
          ...
          <div className="flex flex-col gap-2 text-sm text-muted-foreground">
            ...
            <ol className="list-decimal list-inside flex flex-col gap-1 pl-1">
              ...
              <li>
                Drag the button above to your browser&apos;s bookmark bar.
              </li>
              <li>
